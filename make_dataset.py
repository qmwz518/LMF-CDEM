...
if __name__ == '__main__':
    ...
    parser.add_argument('--wide', type=int, default=192)
    parser.add_argument('--path', type=str, default='/content/drive/MyDrive/LMF/traindata')
